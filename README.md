# WIP PyPas - The CyberArk Core PAS API Wrapper

This project is work in progess.
The API wrapper is intended to ease the usage of the CyberArk Core PAS API (Self-Hosted) by abstracting implementation details away from developers.
